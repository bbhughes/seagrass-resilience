...
plot_predictions("3", legend_position = c(.87, .23))
ggsave("figs/fig-3.pdf", width = 4.5, height = 2.1)
plot_predictions("4", legend_position = c(.83, .9))
ggsave("figs/fig-4.pdf", width = 4.5, height = 2.3)
plot_predictions("5", legend_position = c(.15, .1))
ggsave("figs/fig-5.pdf", width = 4.5, height = 3.8)
plot_predictions("6", legend_position = c(.87, .9))
ggsave("figs/fig-6.pdf", width = 6.9, height = 2.3)
